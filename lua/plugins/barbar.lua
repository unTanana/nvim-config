return {
	{
		...
		init = function()
			...
			map("n", "<leader>we", "<Cmd>BufferCloseBuffersRight<CR>", opts)
			map("n", "<leader>wq", "<Cmd>BufferCloseBuffersLeft<CR>", opts)
			map("n", "<leader>ws", "<Cmd>BufferCloseAllButCurrentOrPinned<CR>", opts)
			map("n", "<leader>T", "<Cmd>BufferRestore<CR>", opts)
